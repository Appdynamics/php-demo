...
then   
    ...
    cp ${AGENT_INSTALL} .appdynamics/appdynamics-php-agent-x64-linux-4.0.0.0.tar.bz2
  ...
  then
    ...
    then
        ...
        wget --load-cookies cookies.txt https://download.appdynamics.com/onpremise/public/latest/appdynamics-php-agent-x64-linux-4.0.0.0.tar.bz2 -O .appdynamics/appdynamics-php-agent-x64-linux-4.0.0.0.tar.bz2
        if [ $? -ne 0 ]; then
            rm cookies.txt index.html*
            exit 
        fi
        AGENT_INSTALL=".appdynamics/appdynamics-php-agent-x64-linux-4.0.0.0.tar.bz2"
...
cp .appdynamics/appdynamics-php-agent-x64-linux-4.0.0.0.tar.bz2 bundy_webserver/
cp .appdynamics/appdynamics-php-agent-x64-linux-4.0.0.0.tar.bz2 bundy_fulfillment/
...
#(cd php-demo/bundy_webserver; docker build -t appdynamics/bundy_web .)
#(cd php-demo/bundy_fulfillment; docker build -t appdynamics/bundy_ful .)
#(cd php-demo/bundy_inventory; docker build -t appdynamics/bundy_inv .)
#(cd php-demo; rm -rf bundy_webserver/appdynamics-php-agent-x64-linux-4.0.0.0.tar.bz2 bundy_webserver/MachineAgent.zip bundy_fulfillment/appdynamics-php-agent-x64-linux-4.0.0.0.tar.bz2 bundy_fulfillment/MachineAgent.zip bundy_inventory/AppServerAgent.zip)
