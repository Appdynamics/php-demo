...
apelj=${MACHINE_AGENT_HOME}/monitors/analytics-agent/conf/job/bundy_fulfillment-error-log.job
...
# Log file location is pre-configured and log analytics enabled
apalj=${MACHINE_AGENT_HOME}/monitors/analytics-agent/conf/job/bundy_fulfillment-access-log.job
