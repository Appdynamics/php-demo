...
sed -i "s/<tier-name>/<tier-name>${FUL_TIER_NAME}/g" /${AGENT_HOME}/conf/controller-info.xml
echo " tier-name: ${FUL_TIER_NAME}"
sed -i "s/<node-name>/<node-name>${FUL_NODE_NAME}/g" /${AGENT_HOME}/conf/controller-info.xml
echo " node-name: ${FUL_NODE_NAME}"
