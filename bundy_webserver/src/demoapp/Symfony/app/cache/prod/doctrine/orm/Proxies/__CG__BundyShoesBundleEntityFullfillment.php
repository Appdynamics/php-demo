...
namespace Proxies\__CG__\Bundy\ShoesBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Fullfillment extends \Bundy\ShoesBundle\Entity\Fullfillment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Fullfillment $proxy) {
