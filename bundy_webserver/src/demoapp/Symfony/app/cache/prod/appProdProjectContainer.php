...
class appProdProjectContainer extends Container
{
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'bundy_shoes.config' => 'getBundyShoes_ConfigService',
            'bundy_shoes.fedexservice' => 'getBundyShoes_FedexserviceService',
            'bundy_shoes.javaservice' => 'getBundyShoes_JavaserviceService',
            'bundy_shoes.phpservice' => 'getBundyShoes_PhpserviceService',
            'bundy_shoes.session' => 'getBundyShoes_SessionService',
            'bundy_shoes.visaservice' => 'getBundyShoes_VisaserviceService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Users/rbolton/Sites/bundyshoes/Symfony/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $a = $this->get('assetic.asset_factory');
        $b = $this->get('templating.loader');
        $c = new \Assetic\Cache\ConfigCache('/Users/rbolton/Sites/bundyshoes/Symfony/app/cache/prod/assetic/config');
    ...
    protected function getBundyShoes_ConfigService()
    {
        return $this->services['bundy_shoes.config'] = new \Bundy\ShoesBundle\DependencyInjection\Services\Config(array('transaction_slow' => true, 'exception_thrown' => true, 'php_error' => true, 'eum_enabled' => true, 'eum_key' => 'AD-AAB-AWM'));
    }
    protected function getBundyShoes_FedexserviceService()
    {
        return $this->services['bundy_shoes.fedexservice'] = new \Bundy\ShoesBundle\DependencyInjection\Services\HttpClient('localhost', 80, 'local.bundyshoes.com');
    }
    protected function getBundyShoes_JavaserviceService()
    {
        return $this->services['bundy_shoes.javaservice'] = new \Bundy\ShoesBundle\DependencyInjection\Services\HttpClient('localhost', 80, 'local.bundyshoes.com');
    }
    protected function getBundyShoes_PhpserviceService()
    {
        return $this->services['bundy_shoes.phpservice'] = new \Bundy\ShoesBundle\DependencyInjection\Services\HttpClient('localhost', 80, 'local.bundydownstream.com');
    }
    ...
    protected function getBundyShoes_VisaserviceService()
    {
        return $this->services['bundy_shoes.visaservice'] = new \Bundy\ShoesBundle\DependencyInjection\Services\HttpClient('localhost', 80, 'local.bundyshoes.com');
    }
    ...
    {
        return $this->services['doctrine.dbal.crm_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'CRM', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => 'webdev1', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_CrmEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_crm_75ab19deb50ee827c2092763db9a776cd6bf91987c85026031a03aaaaa229f93');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_crm_75ab19deb50ee827c2092763db9a776cd6bf91987c85026031a03aaaaa229f93');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_crm_75ab19deb50ee827c2092763db9a776cd6bf91987c85026031a03aaaaa229f93');
        ...
        $e->setProxyDir('/Users/rbolton/Sites/bundyshoes/Symfony/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_75ab19deb50ee827c2092763db9a776cd6bf91987c85026031a03aaaaa229f93');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_75ab19deb50ee827c2092763db9a776cd6bf91987c85026031a03aaaaa229f93');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_75ab19deb50ee827c2092763db9a776cd6bf91987c85026031a03aaaaa229f93');
        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/Users/rbolton/Sites/bundyshoes/Symfony/src/Bundy/ShoesBundle/Entity')), 'Bundy\\ShoesBundle\\Entity');
        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('BundyShoesBundle' => 'Bundy\\ShoesBundle\\Entity'));
    ...
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_fullfillment_75ab19deb50ee827c2092763db9a776cd6bf91987c85026031a03aaaaa229f93');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_fullfillment_75ab19deb50ee827c2092763db9a776cd6bf91987c85026031a03aaaaa229f93');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_fullfillment_75ab19deb50ee827c2092763db9a776cd6bf91987c85026031a03aaaaa229f93');
        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/Users/rbolton/Sites/bundyshoes/Symfony/src/Bundy/ShoesBundle/Entity')), 'Bundy\\ShoesBundle\\Entity');
        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('BundyShoesBundle' => 'Bundy\\ShoesBundle\\Entity'));
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/Users/rbolton/Sites/bundyshoes/Symfony/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Users/rbolton/Sites/bundyshoes/Symfony/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Users/rbolton/Sites/bundyshoes/Symfony/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/Users/rbolton/Sites/bundyshoes/Symfony/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Users/rbolton/Sites/bundyshoes/Symfony/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Users/rbolton/Sites/bundyshoes/Symfony/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/rbolton/Sites/bundyshoes/Symfony/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Users/rbolton/Sites/bundyshoes/Symfony/app/cache/prod',
            ...
            'php_host' => 'localhost',
            'php_port' => 80,
            'php_hostname' => 'local.bundydownstream.com',
            'fedex_host' => 'localhost',
            'fedex_port' => 80,
            'fedex_hostname' => 'local.bundyshoes.com',
            'visa_host' => 'localhost',
            'visa_port' => 80,
            'visa_hostname' => 'local.bundyshoes.com',
            'config' => array(
            ...
            'session.save_path' => '/Users/rbolton/Sites/bundyshoes/Symfony/app/cache/prod/sessions',
            ...
            'router.resource' => '/Users/rbolton/Sites/bundyshoes/Symfony/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/rbolton/Sites/bundyshoes/Symfony/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/Users/rbolton/Sites/bundyshoes/Symfony/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Users/rbolton/Sites/bundyshoes/Symfony/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/Users/rbolton/Sites/bundyshoes/Symfony/app/cache/prod/doctrine/orm/Proxies',
