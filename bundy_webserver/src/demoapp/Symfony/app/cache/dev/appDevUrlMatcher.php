...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/health')) {
            // bundy_shoes_health_shipping
            if ($pathinfo === '/health/shipping') {
                return array (  '_controller' => 'Bundy\\ShoesBundle\\Controller\\HealthController::shippingAction',  '_route' => 'bundy_shoes_health_shipping',);
            }

            // bundy_shoes_health_payment
            if ($pathinfo === '/health/payment') {
                return array (  '_controller' => 'Bundy\\ShoesBundle\\Controller\\HealthController::paymentAction',  '_route' => 'bundy_shoes_health_payment',);
            }

            if (0 === strpos($pathinfo, '/health/javamock')) {
                // bundy_shoes_health_javamock
                if ($pathinfo === '/health/javamock') {
                    return array (  '_controller' => 'Bundy\\ShoesBundle\\Controller\\HealthController::javamockAction',  '_route' => 'bundy_shoes_health_javamock',);
                }

                // bundy_shoes_health_javamock_slow
                if ($pathinfo === '/health/javamock_slow') {
                    return array (  '_controller' => 'Bundy\\ShoesBundle\\Controller\\HealthController::javamockAction',  '_route' => 'bundy_shoes_health_javamock_slow',);
                }
